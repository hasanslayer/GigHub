...
namespace GigHub.Tests.Controllers.Api
{
    ...
    public class AttendancesControllerTests
    {
        ...
        [TestMethod]
        public void DeleteAttend_NoAttendanceWithGivenIdExists_ShouldReturnNotFound()
        {
            var result = _controller.DeleteAttend(1);

            result.Should().BeOfType<NotFoundResult>();
        }

        [TestMethod]
        public void DeleteAttend_ValidRequest_ShouldReturnOk()
        {
            var attendance = new Attendance();
        ...
        [TestMethod]
        public void DeleteAttend_ValidRequest_ShouldReturnTheIdOfDeletedAttendance()
        {
            var attendance = new Attendance();
            _mockRepository.Setup(r => r.GetAttendance(1, _userId)).Returns(attendance);

            var result = (OkNegotiatedContentResult<int>)_controller.DeleteAttend(1);
